			...
			case 'jpg':
				{
					...
					{
						rename($this->_config->path->data.'/userimg/tmp/'.$this->_imgName, $this->_config->path->data.'/days/'.$this->_imgName);
						return true;
					}
					$scale=$this->_o_width/580;
					...
					}catch(Exception $e)
				{
					...
					$result=imagejpeg($dst_r,$this->_config->path->data.'/days/'.$this->_imgName,$jpeg_quality);
			}
			break;
			case 'gif':
			{
					...
					}catch(Exception $e)
				{
					...
					$result=imagegif($dst_r,$this->_config->path->data.'/days/'.$this->_imgName,$jpeg_quality);
			}
			break;
			default:
			{
					...
					}catch(Exception $e)
				{
					...
					$result=imagepng($dst_r,$this->_config->path->data.'/days/'.$this->_imgName);
			}
		}
