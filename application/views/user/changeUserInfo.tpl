		<form action="{#public#}valid/userinfo" class="form-horizontal" method="post" id="userinfo">
			<div id="formMain">
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="name" placeholder="First Name" required id="firstname" name="firstname"/>
							</div>	
						</div>
						<div class="control-group">
							<label for="lastname" class="control-label">Last Name</label>
							<div class="controls">
								<input type="text" required class="name"  placeholder="Last Name" name="lastname" id="lastname"/>
							</div>
						</div>
						<div class="control-group">
							<label for="genderGirl" class="control-label">Gender</label>
							<div class="controls">
								<input type='radio' value="boy" name="gender" id="genderBoy"/>Man
								<input type='radio' value="girl"  checked="true" name="gender" id="genderGirl" />Woman
							</div>
						</div>
       <div class="control-group">
			...
			<div class="controls">
				...
				<a id="add"  data-toggle='modal' href="#birthdayImportant">Why it is important？</a>
			</div>
		</div>
						<div class="control-group">
								<label for="provinceCities" class="control-label">Please choose your hometown </label>
								<div class="controls">
						...
						<div class="control-group">
							<label for="usProvince" class="control-label">Choose your university</label>
							<div class="controls">
								...
								<p class="help-block">还没有上过大学，没关系，你可以略过这一项.
							</div>
							
						</div>
						<div class="control-group">
							<label for="perimt" class="control-label">Purview</label>
							<div class="controls">
								<select id="permit"	name="permit">
									<option value="2">Your followers can see</option>
									<option value="3">Public Wall can see</option>
									<option value="4">Only yourself</option>
								</select>
							</div>
						</div>
						<div class="control-group">
