			...
			<div class="span9">
				...
				<h4>People You Collect</h4>
			   	...
			   	{foreach from=$result item=item}
				   	<div class="friendInfo thumbnail" >
				   		...
				   		<hr />
				   			...
				   			<p><a href="#deleteFriend" data-toggle="modal"  class="delete" data="{$item.user_id}"><button class="btn btn-mini" >Drop</button></a>
				   		</div>
			   	...
			   	<div class="modal fade" id="deleteFriend" >
				    ...
				    <p>Are you sure to drop this person?It may be very sad for your action</p>
				    </div>
